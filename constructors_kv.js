...
const modulesLibrary = {
    ...
    header_construct: { name: "◆》》》КОНСТРУКЦИОННЫЕ МОДУЛИ《《《◆", price: 0, category: 'Конструкционные модули', visibility: 0, power: 0, capacity: 0, crewProvided: 0, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 10, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: "Разделитель" },
    header_ai: { name: "◆》》》МОДУЛИ ИИ 《《《◆", price: 0, category: 'Конструкционные модули', visibility: 0, power: 0, capacity: 0, crewProvided: 0, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 10, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: "Разделитель" },
    header_ew: { name: "◆》》》МОДУЛИ ЭЛЕКТРОННОЙ ВОЙНЫ《《《◆", price: 0, category: 'Конструкционные модули', visibility: 0, power: 0, capacity: 0, crewProvided: 0, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 10, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: "Разделитель" },
    header_troops: { name: "◆》》》ЭКИПАЖ И ДЕСАНТ《《《◆", price: 0, category: 'Конструкционные модули', visibility: 0, power: 0, capacity: 0, crewProvided: 0, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 10, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: "Разделитель" },
    header_station: { name: "◆》》》МОДУЛИ СТАНЦИИ 《《《◆", price: 0, category: 'Конструкционные модули', visibility: 0, power: 0, capacity: 0, crewProvided: 0, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 10, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: "Разделитель" },
    ...
    // --- ОБОРУДОВАНИЕ ---
    ftl_ramon: { name: '«FTL Гипердвигатель «Рамонь»', price: 30000000, category: 'Конструкционные модули', visibility: 0, power: 300, capacity: 0, crewProvided: 0, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 0, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Двигатель, использующий переработанный Старвис.' },
    living_module: { name: 'Складской отсек', price: 900000, category: 'Конструкционные модули', visibility: 0, power: 50, capacity: 10, crewProvided: 0, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 10, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Модуль для транспортировки грузов и говна.' },
    drocil: { name: 'Трюм', price: 1700000, category: 'Конструкционные модули', visibility: 0, power: 50, capacity: 10, crewProvided: 0, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 10, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Полный кала' },
    docking_port: { name: 'Стыковочный шлюз', price: 6000000, category: 'Конструкционные модули', visibility: 0, power: 250, capacity: 100, crewRequired: 0, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 10, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Ничем непримечательный шлюз.' },
    transponder: { name: 'Ренегатский транспондер', price: 15000000, category: 'Конструкционные модули', power: 500, crewRequired: 1, visibility: 0, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 50, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Имитирует сигнатуры военных кораблей.' },
    sidis_defense: { name: 'Сидисский комплекс активной защиты', price: 30000000, category: 'Конструкционные модули', power: 500, crewRequired: 10, visibility: 100, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 50, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'КАЗ с радаром управления огнем.' },
    hangar: { name: 'Ангар', price: 25000000, category: 'Конструкционные модули', visibility: 0, power: 1200, capacity: 600, crewRequired: 20, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 10, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Ангары многофункциональны.' },
    tocka: { name: 'Лазерная точечная защита', price: 5000000, category: 'Конструкционные модули', visibility: 10, power: 500, capacity: 0, crewRequired: 5, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 0, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Типо защита ПВО/ПРО' },
    ...
    // --- РЭБ ---
    ew_blackdomain: { name: 'Ретранслятор-заградитель «Черный домен»', price: 20000000, category: 'Модули радиотумана', visibility: 0, power: 600, capacity: 0, crewRequired: 5, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 50, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Блокирует все виды FTL.' },
    ew_graywave: { name: 'Ретранслятор-заградитель «Серая волна»', price: 35000000, category: 'Модули радиотумана', visibility: 0, power: 450, capacity: 0, crewRequired: 5, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 50, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Продвинутый метод заграждения.' },
    ew_orwell: { name: 'Радио Туман «Оруэл» СРТ-25', price: 20000000, category: 'Модули радиотумана', visibility: 0, power: 500, capacity: 0, crewRequired: 5, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 100, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Полностью блокирует астрогацию и наведение.' },
    ew_bradbury: { name: 'Радио Туман «Брэдбери» РБТ-20', price: 22000000, category: 'Модули радиотумана', visibility: 0, power: 400, capacity: 0, crewRequired: 5, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 50, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Блокирует только системы наблюдения.' },
    ew_arcady: { name: 'Радио Туман «Аркадий С.» РТС-30', price: 24000000, category: 'Модули радиотумана', visibility: 0, power: 500, capacity: 0, crewRequired: 5, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 100, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Нейтрализует Оруэл.' },
    ew_boris: { name: 'Радио Туман «Борис С.» ССК-35', price: 21000000, category: 'Модули радиотумана', visibility: 0, power: 600, capacity: 0, crewRequired: 5, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 50, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Позволяет вести союзные переговоры.' },
    ew_asimov: { name: 'Радио Туман «Азимов» СРТ-40', price: 25000000, category: 'Модули радиотумана', visibility: 0, power: 600, capacity: 0, crewRequired: 5, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 100, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Радио туманное око.' },
    ew_starker: { name: 'Штурмовой заградитель «Штаркерштат»', price: 50000000, category: 'Модули радиотумана', visibility: 0, power: 1500, capacity: 0, crewRequired: 10, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 100, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Агрессивная форма интердикции.' },
    ew_altaan: { name: 'Стабилизационное поле «Альтаан»', price: 55000000, category: 'Модули радиотумана', visibility: 0, power: 900, capacity: 0, crewRequired: 5, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 100, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Анти-интердикция.' },
    ew_heinlein: { name: 'Радио Туман «Хайнлайн» СРТ-45', price: 26000000, category: 'Модули радиотумана', visibility: 0, power: 700, capacity: 0, crewRequired: 5, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 100, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, lor: 'Разведка вокруг радиотумана.' },
...
const modules_ids = {
    peh: ['empty'],
    btr: ['empty', 'header_troops', 'crew_extra', 'desantnik', 'drone_cargo'],
    tanki: ['empty', 'header_troops', 'crew_extra', 'drone_cargo'],
    arta: ['empty', 'header_troops', 'crew_extra'],
    aviacia: ['empty', 'crew_extra', 'desantnik', 'drone_cargo'],
    vertihui: ['empty', 'header_troops', 'crew_extra', 'desantnik', 'drone_cargo'],
    dron: ['empty'],
    dronkos: ['empty'],
    mla: ['empty', 'header_troops', 'crew_extra'],
    corvette: [
        'empty', 'drocil', 'header_construct', 'ftl_ramon', 'living_module', 'docking_port', 'transponder', 'sidis_defense',
        'header_ew', 'ew_blackdomain', 'ew_graywave', 'ew_orwell', 'ew_bradbury', 'ew_arcady', 'ew_boris', 'ew_asimov',
        'header_troops', 'cargo_support', 'crew_extra', 'desantnik', 'btr_platform', 'tank_platform', 'arta_platform', 'drone_cargo', 'atmo_aviation', 'heli_platform'
    ],
    destroyer: [
        'empty', 'drocil', 'header_construct', 'ftl_ramon', 'living_module', 'docking_port', 'transponder', 'sidis_defense', 'tocka',
        'header_ew', 'ew_blackdomain', 'ew_graywave', 'ew_orwell', 'ew_bradbury', 'ew_arcady', 'ew_boris', 'ew_asimov',
        'header_troops', 'cargo_support', 'crew_extra', 'desantnik', 'btr_platform', 'tank_platform', 'arta_platform', 'drone_cargo', 'atmo_aviation', 'heli_platform'
    ],
    supportCarrier: [
        'empty', 'drocil', 'header_construct', 'ftl_ramon', 'living_module', 'docking_port', 'hangar', 'transponder', 'sidis_defense', 'tocka',
        'header_ew', 'ew_blackdomain', 'ew_graywave', 'ew_orwell', 'ew_bradbury', 'ew_arcady', 'ew_boris', 'ew_asimov',
        'header_troops', 'cargo_support', 'crew_extra', 'desantnik', 'btr_platform', 'tank_platform', 'arta_platform', 'drone_cargo', 'atmo_aviation', 'heli_platform'
    ],
    mediumCruiser: [
        'empty', 'drocil', 'header_construct', 'ftl_ramon', 'living_module', 'docking_port', 'transponder', 'sidis_defense', 'tocka',
        'header_ew', 'ew_blackdomain', 'ew_graywave', 'ew_starker', 'ew_altaan', 'ew_orwell', 'ew_bradbury', 'ew_arcady', 'ew_boris', 'ew_asimov', 'ew_heinlein',
        'header_troops', 'cargo_support', 'crew_extra', 'desantnik', 'btr_platform', 'tank_platform', 'arta_platform', 'drone_cargo', 'atmo_aviation', 'heli_platform'
    ],
    hyperCruiser: [
        'empty', 'drocil', 'header_construct', 'living_module', 'docking_port', 'transponder', 'sidis_defense', 'tocka',
        'header_ew', 'ew_blackdomain', 'ew_graywave', 'ew_starker', 'ew_altaan', 'ew_orwell', 'ew_bradbury', 'ew_arcady', 'ew_boris', 'ew_asimov', 'ew_heinlein',
        'header_troops', 'cargo_support', 'crew_extra', 'desantnik', 'btr_platform', 'tank_platform', 'arta_platform', 'drone_cargo', 'atmo_aviation', 'heli_platform'
    ],
    multiroleCarrier: [
    ...
    dreadnought: [
        'empty', 'drocil', 'header_construct', 'ftl_ramon', 'living_module', 'docking_port', 'hangar', 'transponder', 'sidis_defense', 'tocka',
        'header_ew', 'ew_blackdomain', 'ew_graywave', 'ew_starker', 'ew_altaan', 'ew_orwell', 'ew_bradbury', 'ew_arcady', 'ew_boris', 'ew_asimov', 'ew_heinlein',
        'header_troops', 'cargo_support', 'crew_extra'
    ],
    ss13: [
        'empty', 'drocil', 'header_station', 'st_astartek', 'st_kolomor', 'st_docks', 'st_medbay', 'st_habitat', 'st_trade', 'st_lancer', 'tocka',
        'header_construct', 'living_module', 'hangar', 'transponder', 'sidis_defense',
        'header_ew', 'ew_blackdomain', 'ew_graywave', 'ew_starker', 'ew_altaan', 'ew_orwell', 'ew_bradbury', 'ew_arcady', 'ew_boris', 'ew_asimov', 'ew_heinlein',
        'header_troops', 'crew_extra'
    ]
};
...
const modules5 = {
  peh: [
    ...
    { name: 'Портативная радиолокационная станция ЕБ-44 КА', price: 200000, crewProvided: 0, crewRequired: 0, modulBoost: 2, category: 'Радары', power: 0, dalnostBoost: 2, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
  ...
  btr: [
    ...
    { name: 'Оптико-электронная система «Око»', price: 200000, crewProvided: 0, crewRequired: 0, modulBoost: 2, category: 'Радары', power: 20,dalnostBoost: 1, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
    { name: 'Лазерный дальномер «Марка»', price: 400000, crewProvided: 0, crewRequired: 0, modulBoost: 2, category: 'Радары', power: 20,dalnostBoost: 3, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
    { name: 'Активная радиолокационная станция «Притяжение»', price: 400000, crewProvided: 0, crewRequired: 0, modulBoost: 2, category: 'Радары', power: 50, dalnostBoost: 8, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
  ...
  tanki: [
    { name: 'Не выбран', price: 0, crewProvided: 0, crewRequired: 0, modulBoost: 0, category: 'Радары', power: 0,dalnostBoost: 0, customParameterradar: { dalnost: 0, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 0, kristall: 0, staarvis: 0 }, description: "..."  },
    { name: 'Оптико-электронная система «Око»', price: 200000, crewProvided: 0, crewRequired: 0, modulBoost: 2, category: 'Радары', power: 20,dalnostBoost: 1, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
    { name: 'Беспилотный летательный аппарат «Цедра»', price: 700000, crewProvided: 0, crewRequired: 0, modulBoost: 2, category: 'Радары', power: 10, dalnostBoost: 8, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
  ...
  aviacia: [
    { name: 'Не выбран', price: 0, crewProvided: 0, crewRequired: 0, modulBoost: 0, category: 'Радары', power: 0,dalnostBoost: 0, customParameterradar: { dalnost: 0, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 0, kristall: 0, staarvis: 0 }, description: "..."  },
    { name: 'Активная радиолокационная станция «Радиоромантик» А1»', price: 1000000, crewProvided: 0, crewRequired: 0, modulBoost: 2, category: 'Радары', power: 100, dalnostBoost: 4, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
    { name: 'Пассивная радиолокационная станция «Рубикория IV»', price: 2000000, crewProvided: 0, crewRequired: 0, modulBoost: 6, category: 'Радары', power: 500, dalnostBoost: 10, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
  ...
  corvette: [
    { name: 'Не выбран', price: 0, crewProvided: 0, crewRequired: 0, modulBoost: 0, category: 'Радары', power: 0,dalnostBoost: 0, customParameterradar: { dalnost: 0, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 0, kristall: 0, staarvis: 0 }, description: "..."  },
    { name: 'Оптико-электронная система «ИКС-Y»', price: 500000, crewProvided: 0, crewRequired: 0, modulBoost: 2, category: 'Радары', power: 50,dalnostBoost: 2, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
    { name: 'Активная радиолокационная станция «Радиоромантик» А1»', price: 1000000, crewProvided: 0, crewRequired: 0, modulBoost: 2, category: 'Радары', power: 100, dalnostBoost: 4, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
    { name: 'Пассивная радиолокационная станция «Рубикория IV»', price: 2000000, crewProvided: 0, crewRequired: 0, modulBoost: 6, category: 'Радары', power: 500, dalnostBoost: 10, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
    { name: 'ЛИДАР «Лучевая душа»', price: 1000000, crewProvided: 0, crewRequired: 0, modulBoost: 6, category: 'Радары', power: 350, dalnostBoost: 5, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
  ...
  mediumCruiser: [
    ...
    { name: 'Пассивная радиолокационная станция «Рубикория IV»', price: 2000000, crewProvided: 0, crewRequired: 0, modulBoost: 6, category: 'Радары', power: 500, dalnostBoost: 10, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
    { name: 'ЛИДАР «Лучевая душа»', price: 1000000, crewProvided: 0, crewRequired: 0, modulBoost: 6, category: 'Радары', power: 350, dalnostBoost: 5, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
    { name: 'ГРАВИК «Лира»', price: 80000000, crewProvided: 0, crewRequired: 0, modulBoost: 6, category: 'Радары', power: 500, dalnostBoost: 6, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
  ],
  hyperCruiser: [
    { name: 'Не выбран', price: 0, crewProvided: 0, crewRequired: 0, modulBoost: 0, category: 'Радары', power: 0,dalnostBoost: 0, customParameterradar: { dalnost: 0, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 0, kristall: 0, staarvis: 0 }, description: "..."  },
    { name: 'Оптико-электронная система «ИКС-Y»', price: 500000, crewProvided: 0, crewRequired: 0, modulBoost: 2, category: 'Радары', power: 50,dalnostBoost: 2, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
    ...
    { name: 'ЛИДАР «Лучевая душа»', price: 1000000, crewProvided: 0, crewRequired: 0, modulBoost: 6, category: 'Радары', power: 350, dalnostBoost: 5, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
    { name: 'ГРАВИК «Лира»', price: 80000000, crewProvided: 0, crewRequired: 0, modulBoost: 6, category: 'Радары', power: 500, dalnostBoost: 6, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
    { name: 'ПП-сонар', price: 90000000, crewProvided: 0, crewRequired: 0, modulBoost: 6, category: 'Радары', power: 500, dalnostBoost: 4, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
  ],
  multiroleCarrier: [
    { name: 'Не выбран', price: 0, crewProvided: 0, crewRequired: 0, modulBoost: 0, category: 'Радары', power: 0,dalnostBoost: 0, customParameterradar: { dalnost: 0, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 0, kristall: 0, staarvis: 0 }, description: "..."  },
    { name: 'Оптико-электронная система «ИКС-Y»', price: 500000, crewProvided: 0, crewRequired: 0, modulBoost: 2, category: 'Радары', power: 50,dalnostBoost: 2, customParameterradar: { dalnost: 5, diapazon: 'c' }, resurs: { blackmetall: 5, coloredmetall: 3, rudametall: 1, kristall: 0, staarvis: 0 }, description: "..."  },
