...
"use strict";
      ...
      // МОДУЛЬНАЯ ПЛАТА: grid = [ширина, высота] решётки отсеков, modul = w*h (предел).
      // Ячеек нарочно много — потолок больше не главный ограничитель: эффективность
      // модуля считается по СОСЕДЯМ (см. cnModPlate в constructors.js). Забить плату
      // всем подряд можно, только выхлоп будет полудохлый.
      const shipClasses = {
        ...
        btr: { hp: 0, size: 2, orugie: 2, modul: 3, crewRequired: 2, price: 500000, capacity: 70, shieldBoost: 0, speed: 1, resurs: { blackmetall: 5, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 2 }, mass: 13600, gabarit: 5, xxx: "БТР" },
          tanki: { hp: 0, size: 2, orugie: 3, modul: 2, crewRequired: 3, price: 900000, capacity: 130, shieldBoost: 0, speed: 1, resurs: { blackmetall: 10, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 5 }, mass: 46500, gabarit: 9, xxx: "Танк" },
          arta: { hp: 0, size: 1, orugie: 2, modul: 1, crewRequired: 10, price: 2000000, capacity: 160, shieldBoost: 0, speed: 1, resurs: { blackmetall: 10, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 10 }, mass: 5000, gabarit: 4, xxx: "Артиллерия" },
          aviacia: { hp: 0, size: 1, orugie: 5, modul: 2, crewRequired: 1, price: 1500000, capacity: 80, shieldBoost: 0, speed: 1, resurs: { blackmetall: 5, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 15 }, mass: 20000, gabarit: 7, xxx: "Атмосферная авиация" },
          vertihui: { hp: 0, size: 1, orugie: 6, modul: 2, crewRequired: 3, price: 3000000, capacity: 100, shieldBoost: 0, speed: 1, resurs: { blackmetall: 5, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 10 }, mass: 8000, gabarit: 5, xxx: "Вертолет" },
          ...
          mla: { hp: 0, size: 1, orugie: 5, modul: 1, crewRequired: 1, price: 1500000, capacity: 80, shieldBoost: 0, speed: 1, resurs: { blackmetall: 5, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 15 }, mass: 20000, gabarit: 7, xxx: "Звездолет" },
      ...
      //    satelloid: { hp: 0, size: 1, orugie: 1, modul: 0, crewRequired: 10, price: 5000000, capacity: 100, shieldBoost: 8, speed: 1, resurs: { blackmetall: 100, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 50 }, mass: 60500, gabarit: 20, xxx: "Сателлоид" },
          corvette: { hp: 0, size: 1, orugie: 1, modul: 24, grid: [6, 4], crewRequired: 20, price: 15000000, capacity: 250, shieldBoost: 1, speed: 1, resurs: { blackmetall: 200, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 30 }, mass: 90000, gabarit: 100, xxx: "Корвет" },
          destroyer: { hp: 0, size: 1, orugie: 1, modul: 32, grid: [8, 4], crewRequired: 30, price: 30000000, capacity: 400, shieldBoost: 9, speed: 1, resurs: { blackmetall: 300, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 50 }, mass: 109500, gabarit: 150, xxx: "Эсминец" },
          supportCarrier: { hp: 0, size: 1, orugie: 1, modul: 40, grid: [8, 5], crewRequired: 25, price: 45000000, capacity: 600, shieldBoost: 15, speed: 1, resurs: { blackmetall: 400, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 100 }, mass: 100000, gabarit: 80, xxx: "Поддерживающий авианосец" },
        //  lightCruiser: { hp: 0, size: 1, orugie: 1, modul: 0, crewRequired: 40, price: 60000000, capacity: 0, shieldBoost: 13, speed: 1, resurs: { blackmetall: 600, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 0 }, mass: 200000, gabarit: 300, xxx: "Лёгкий крейсер" },
          mediumCruiser: { hp: 0, size: 3, orugie: 1, modul: 45, grid: [9, 5], crewRequired: 50, price: 75000000, capacity: 700, shieldBoost: 40, speed: 1, resurs: { blackmetall: 800, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 200 }, mass: 250000, gabarit: 400, xxx: "Средний крейсер" },
          hyperCruiser: { hp: 0, size: 1, orugie: 1, modul: 60, grid: [10, 6], crewRequired: 40, price: 100000000, capacity: 600, shieldBoost: 14, speed: 1, resurs: { blackmetall: 1000, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 800 }, mass: 200000, gabarit: 220, xxx: "Факельщик" },
          multiroleCarrier: { hp: 0, size: 1, orugie: 1, modul: 60, grid: [10, 6], crewRequired: 40, price: 120000000, capacity: 5500, shieldBoost: 19, speed: 1, resurs: { blackmetall: 1200, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 400 }, mass: 230000, gabarit: 350, xxx: "Многоцелевой авианосец" },
          battleship: { hp: 0, size: 2, orugie: 1, modul: 84, grid: [12, 7], crewRequired: 70, price: 200000000, capacity: 1200, shieldBoost: 40, speed: 1, resurs: { blackmetall: 1500, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 1000 }, mass: 400000, gabarit: 500, xxx: "Линкор" },
          dreadnought: { hp: 0, size: 3, orugie: 1, modul: 112, grid: [14, 8], crewRequired: 100, price: 250000000, capacity: 1800, shieldBoost: 40, speed: 1, resurs: { blackmetall: 1800, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 4000 }, mass: 500000, gabarit: 800, xxx: "Дредноут" },
          ss13: { hp: 0, size: 4, orugie: 1, modul: 160, grid: [16, 10], crewRequired: 250, price: 70000000, capacity: 1000, shieldBoost: 40, speed: 1, resurs: { blackmetall: 2000, coloredmetall: 0, rudametall: 0, kristall: 0, staarvis: 600 }, mass: 450000, gabarit: 400, xxx: "СС-13" }
...
const modulesLibrary = {
    ...
    md_goliath: { name: 'Торпеда «Голиаф»', price: 55000000, category: 'Конструкционные модули', visibility: 40, power: 1300, capacity: 0, crewRequired: 14, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 120, coloredmetall: 50, rudametall: 0, kristall: 40, staarvis: 10 }, combat: { act: 'torpedo', cd: 4, dmg: 13000, rng: 8 }, lor: 'Тяжёлая торпеда с ядерной боевой частью. Идёт по дуге поверх астероидов и накрывает цель и всё, что стоит вплотную к ней (65% урона), — включая ваши борта, если подошли близко.' },
    ...
    md_ram: { name: 'Плазменный таран', price: 34000000, category: 'Конструкционные модули', visibility: 20, power: 1000, capacity: 0, crewRequired: 10, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 100, coloredmetall: 30, rudametall: 0, kristall: 30, staarvis: 0 }, combat: { act: 'ram', cd: 3, dmg: 18000, rng: 1 }, lor: 'Раскаляет нос корабля и швыряет его в борт соседа. Ни щит, ни броня на таран не рассчитаны: поле, обшивка и стойкости почти не работают — удар идёт прямо в корпус. Платой служит дистанция: бить надо вплотную, а вплотную бьют и в ответ.' },
    md_rupture: { name: 'Разрывной таран', price: 38000000, category: 'Конструкционные модули', visibility: 20, power: 1100, capacity: 0, crewRequired: 10, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 110, coloredmetall: 40, rudametall: 0, kristall: 40, staarvis: 0 }, combat: { act: 'rupture', cd: 3, dmg: 11000, rng: 1, val: 0.3 }, lor: 'Таран с зарядом, вспарывающим обшивку: бьёт слабее плазменного, зато сдирает с цели стойкость брони — следующий залп по ней проходит на 30% глубже. Как и всякий таран, идёт сквозь щит и броню.' },
    ...
    md_nuke: { name: 'Ядерная ракета', price: 70000000, category: 'Конструкционные модули', visibility: 50, power: 1800, capacity: 0, crewRequired: 18, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 160, coloredmetall: 70, rudametall: 0, kristall: 60, staarvis: 30 }, combat: { act: 'nuke', cd: 5, dmg: 24000, rng: 14 }, lor: 'Стратегический боеприпас: летит по баллистической дуге через полдоски — астероиды ему не помеха — и выжигает ДВА гекса вокруг эпицентра: 100% в точке подрыва, 75% вплотную, 45% на втором кольце. Подрыв уже не перехватить: ПРО против вспышки бесполезна. Кулдаун такой, что за бой её пускают дважды — если повезёт.' },
    ...
    md_lockdown: { name: 'Гвардейский протокол «Эгида»', price: 35000000, category: 'Конструкционные модули', visibility: 0, power: 1100, capacity: 0, crewRequired: 9, customParameterradar: { dalnost: 0 }, resurs: { blackmetall: 130, coloredmetall: 30, rudametall: 0, kristall: 20, staarvis: 0 }, combat: { act: 'hard', cd: 3, rng: 2, val: 0.5 }, lor: 'Борт объявляет себя гвардейцем строя: до своего следующего хода КАЖДЫЙ удар по союзнику в двух гексах перенаправляется на него — щит, броня и корпус «Эгиды» принимают всё вместо соседей, и сам он при этом получает вполовину меньше урона. Слабое место одно: протокол держится на шине снаряжения. Ракета-подавитель (или любой «Тартар») глушит шину — и строй в тот же миг остаётся без гвардейца.' },
