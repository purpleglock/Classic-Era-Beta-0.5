-- ════════════════════════════════════════════════════════════════════════
--  МИГРАЦИЯ: баланс дохода фабрики/добычи
--  Фабрика: 100 → 200 ГС/ячейку | Добыча: 100 → 50 ГС/ячейку (+ ресурсы)
--
--  Запускать ОТДЕЛЬНО (не весь _economy_setup.sql). Заменяет только функцию
--  economy_accrue — все её зависимости (_faction_mods, _apply_colony_projects,
--  _spy_resolve, _res_price) уже есть в базе.
--
--  Мультиячейковая добыча (несколько ячеек на один ресурс) НЕ требует SQL —
--  бэкенд уже перебирает каждый элемент mining_targets и суммирует добычу.
-- ════════════════════════════════════════════════════════════════════════
