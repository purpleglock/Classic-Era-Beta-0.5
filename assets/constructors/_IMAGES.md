...
потом общий для класса, потом ОБЩИЙ ДЛЯ ВСЕХ КЛАССОВ (без суффикса класса).
Классы: corvette / frigate / destroyer / cruiser / battleship / dreadnought.

**Общие файлы на ВСЮ линейку** (один файл красит все классы, у которых нет своего):
- `ship_class.webp` — тело корабля (палуба)
- `ship_armortex.webp` — текстура брони
- `ship_shieldtex.webp` — текстура щита
- `ship_decor.webp` — декор (нужна альфа)
Слоты для них есть в админке «Оформление кораблей», секция «🌐 Общее для ВСЕХ классов».
