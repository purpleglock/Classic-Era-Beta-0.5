...
<div class="gb-wrap">
  ...
  <main class="gb-main">
    ...
    <section id="gb-buildings" class="gb-section">
      ...
      <p><b>Просперити системы.</b> Доход ГС-зданий зависит не только от слотов, но и от экономического баланса системы, где они стоят. Каждое здание <b>производит</b> и <b>потребляет</b> блага (сырьё · товары · потребление) и труд; население системы даёт труд и ест потребление. Если спрос превышает предложение — дефицит: цены растут (продавцы зарабатывают больше), но при глубоком дефиците потребления/труда система впадает в <b>волнения</b>, а затем в <b>стагнацию</b> (доход в пол). Военные постройки (верфь, военный завод) сами ГС не дают, но создают спрос — оживляют торговлю соседних гражданских зданий или, без снабжения, топят систему. Дефицит не бьёт мгновенно: он <b>копится по ходам</b> (волнения → стагнация) и так же постепенно снимается восстановлением. Соседние системы той же державы по гиперпути немного делятся излишком автоматически (<b>спилловер</b>), а на весь сектор могут влиять события — <b>война, пираты, бум</b>. Баланс виден в обзоре «Держава → по системам» и во вкладке «Территория → Логистика»: гасите дефицит застройкой шахт/фабрик или караванами.</p>

      <p><b>Бедность: последствия и меры.</b> Затяжной дефицит — это не только урезанный доход. Бедные системы <b>теряют население</b> (отток/миграция — доля заселённости падает, что ещё сильнее душит труд и доход), а доведённая до края стагнация выливается в <b>восстание</b>: беспорядки разово грабят казну и подрывают систему на несколько дней. В кабинете это сведено в индекс <b>«Бедность»</b> (обзор) и секцию <b>«Бедность и благополучие»</b> во вкладке «Территория» — карточки бедствующих систем с причинами дефицита и подсказками-рычагами. Коренное лечение — снабжение (фабрики, логистика), но казной можно <b>экстренно поддержать</b> систему: <b>💰 дотация</b> (деньги напрямую поднимают просперити), <b>🍞 продпайки</b> (мгновенно сбивают напряжение) и <b>🚀 экстренный импорт</b> (закрывает дефицит и тормозит рост напряжения). Стоимость мер растёт с населением системы.</p>
