  ...
  <main class="gb-main">
    ...
    <section id="gb-resources" class="gb-section">
      ...
      <ul class="gb-ul">
        ...
        <li>Скорость добычи = <b>редкость × богатство месторождения × доктрина × (слоты ÷ 3)</b>. Слоты — рабочие руки: их выставляет <b>промышленный бюджет</b>, а населения должно хватать (вкладка «Благополучие»).</li>
        <li>Куда идёт добыча — <b>склад, караваны или Товарная биржа</b> — настраивается по каждому ресурсу во вкладке <b>«🔀 Потоки»</b>.</li>
      ...
      <div class="gb-note gb-note-info">
        <span class="gb-note-i">∑</span>
        <div><b>Формула добычи по залежи/сутки:</b> базовая скорость по редкости <b>× множитель богатства залежи × бонус доктрины × (слоты завода ÷ 3)</b>. Минимум — 1/сут. Тот же расчёт сервер применяет при ночном начислении.</div>
      </div>
