...
// Потолка добычи на залежь в живом тике НЕТ (сверено с БД 2026-07-29).
const GB_RICHNESS = [
...
function gbRichTable() {
  ...
  return `<div class="gb-table-wrap"><table class="gb-table">
    <thead><tr><th>Богатство залежи (с карты)</th><th>Множитель темпа добычи</th></tr></thead>
    <tbody>${rows}</tbody>
  </table></div>`;
}
...
<div class="gb-wrap">
  ...
  <main class="gb-main">
    ...
    <section id="gb-resources" class="gb-section">
      ...
      <div class="gb-note gb-note-info">
        <span class="gb-note-i">∑</span>
        <div><b>Формула добычи по залежи/сутки:</b> сумма всех шахт на планете, каждая = базовая скорость по редкости <b>× множитель богатства × бонус доктрины × множитель яруса × множитель слотов</b>, минимум 1. Потолка на залежь нет.</div>
      </div>

      <h3 class="gb-h3">Богатство месторождения</h3>
      <p>У каждой залежи на карте есть <b>богатство</b> — от «следов» до «колоссально». Оно <b>множит темп добычи</b>: ×0.6 у «следов» … ×3.0 у «колоссально». Потолка на залежь нет — постройки складываются, каждая копает свой полный темп.</p>
