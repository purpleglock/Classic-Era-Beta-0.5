...
function gbFigExchange() {
  ...
  const chips = ['🏢 Организации', '📊 Индекс', '🏛 Облигации', '📈 Маржа', '📅 Фьючерсы', '🎲 Опционы'].map(t => `<span>${t}</span>`).join('');
  const body = `<div class="gb-fig-body">
    <div class="gb-chart-hd"><b>📊 Индекс рынка</b><span class="ok">▲ рост котировок</span></div>
    ...
    <div class="gb-chart-base">база 1000 — корзина живых цен всех ресурсов</div>
    <div class="gb-chips2">${chips}</div>
  </div>`;
  return gbFig('Биржа', body, 'Поверх живого рынка — инструменты: <b>организации</b>, <b>индекс</b>-ETF, <b>облигации</b> и деривативы (<b>маржа · фьючерсы · опционы</b>). Сделки с долями — при открытых торгах.');
}
...
<div class="gb-wrap">
  ...
  <main class="gb-main">
    ...
    <section id="gb-exchange" class="gb-section">
      ...
      <h3 class="gb-h3">📊 Индекс рынка (ETF)</h3>
      <p>Индекс — это <b>корзина живых цен всех ресурсов</b> (база = 1000). Покупаете <b>паи</b> на ГС: рынок в целом вырос — паи подорожали, упал — подешевели. Простой способ «поставить на всю экономику» без выбора конкретного ресурса.</p>
      ...
      <p>Это <b>чистые ставки на движение цены</b> ресурса: сам ресурс вы не покупаете, выигрыш и проигрыш приходят деньгами. Внутри каждой под-вкладки есть кнопка «📖 простыми словами» с примером.</p>
      <div class="gb-kv-grid">
        <div class="gb-kv-row"><span class="gb-kv-key">📈 Маржа</span><span class="gb-kv-val"><b>Лонг</b> (ставка на рост) или <b>шорт</b> (на падение) с <b>плечом до ×10</b>. Плечо множит и прибыль, и убыток. ⚠ Дойдёт цена до <b>цены ликвидации</b> — позиция закроется, залог сгорит.</span></div>
      ...
      <div class="gb-note gb-note-tip">
        <span class="gb-note-i">★</span>
        <div>Новичку: начните с <b>индекса</b> или <b>облигаций</b> — там нет ликвидации. Плечо и деривативы оставьте на потом: ×10 «вылетает» уже при движении против вас на ~9–10%.</div>
      </div>
    </section>
