...
<div class="gb-wrap">
  ...
  <main class="gb-main">
    ...
    <section id="gb-research" class="gb-section">
      ...
      <p>В <strong>«Кабинете игрока» → «Технологии»</strong> открывается дерево исследований. Выберите узел — если хватает очков науки, исследование запустится. Базово изучается <b>одна</b> технология за раз (у <a class="gb-link" onclick="gbScrollTo('gb-doctrine')">роботов</a> — на одну больше).</p>
      <ul class="gb-ul">
