  ...
  <main class="gb-main">
    ...
    <section id="gb-colonies" class="gb-section">
      ...
      <div class="gb-table-wrap"><table class="gb-table">
        ...
        <tbody>
          ...
          <tr><td>Газовые / ледяные / горячие гиганты, аномалии, пояса астероидов</td><td><span class="gb-rar gb-rar-5">Колонизировать нельзя</span></td></tr>
        </tbody>
      </table></div>
    ...
    <section id="gb-resources" class="gb-section">
      ...
      <ul class="gb-ul">
        ...
        <li>Откройте слот и <b>назначьте месторождение</b>: 1 слот = 1 ресурс. Без назначения завод даёт только ГС, но не добывает.</li>
    ...
    <section id="gb-constructors" class="gb-section">
      ...
      <p>Дивизия собирается из <b>блоков</b> — пехота, техника, авиация. Чтобы её произвести, нужны соответствующие здания: пехота → <b>Центр подготовки</b>, техника → <b>Военный завод</b>, корабли/авиация → <b>Корабельная верфь</b>. Если нужного здания нет — кнопка производства подскажет, чего не хватает.</p>
