...
<div class="gb-wrap">
  ...
  <main class="gb-main">
    ...
    <section id="gb-resources" class="gb-section">
      ...
      <p>Добыча сама по себе доход не приносит — нужно выбрать канал сбыта:</p>
      <div class="gb-kv-grid">
        <div class="gb-kv-row"><span class="gb-kv-key">💱 Экспорт (караваны)</span><span class="gb-kv-val">Завод в режиме «Экспорт» → добыча идёт в <b>караваны</b> по полной цене (+ дипломатия); остаток авто-продаётся по <b>60%</b>. Лучший доход, но нужен торговый флот и партнёр.</span></div>
        <div class="gb-kv-row"><span class="gb-kv-key">📈 Товарная биржа</span><span class="gb-kv-val">Здание продаёт <b>складские</b> ресурсы каждый цикл: <b>50–75%</b> по редкости. Без партнёров и флота.</span></div>
        <div class="gb-kv-row"><span class="gb-kv-key">Обмен / рынок</span><span class="gb-kv-val">Складские ресурсы можно отдать/продать вручную через бартер (вкладка «Торговля»).</span></div>
      </div>
