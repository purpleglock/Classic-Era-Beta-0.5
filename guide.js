...
<div class="gb-wrap">
  ...
  <main class="gb-main">
    ...
    <section id="gb-resources" class="gb-section">
      ...
      <p>Одним заводом всё не выкопать. Каждая добывающая постройка берёт <b>только залежи своего яруса</b> — под редкие и элитные ресурсы нужны отдельные, куда более дорогие комплексы:</p>
      <div class="gb-table-wrap"><table class="gb-table">
        <thead><tr><th>Постройка</th><th>Цена</th><th>Какие залежи копает</th></tr></thead>
        <tbody>
          ...
          <tr><td>⛏ <b>Экзотический экстрактор</b></td><td>8 000 ГС</td><td><b>Эпические и легендарные</b> (epic, legendary) — единственный способ качать Гравиядро, Программируемую материю и прочие уникальные ресурсы</td></tr>
        </tbody>
      </table></div>
      <div class="gb-note gb-note-warn">
        <span class="gb-note-i">!</span>
        <div>Обычный <b>Добывающий завод не тронет</b> ни редкую, ни элитную залежь — сколько бы слотов вы в него ни вложили. Увидели на планете легендарный ресурс — планируйте <b>Экзотический экстрактор</b>, иначе месторождение просто простаивает.</div>
      </div>

      <h3 class="gb-h3">Как добывать</h3>
      <ul class="gb-ul">
        <li>Постройте добывающую постройку <b>нужного яруса</b> на колонии, у планеты которой есть подходящие залежи.</li>
        <li>Работает <b>автоматически</b>: копает <b>все залежи своего яруса</b> на этой планете сразу, выбирать ничего не нужно.</li>
        <li>Темп по одной залежи = <b>база редкости × богатство месторождения × доктрина × (слоты ÷ 3)</b>, но не выше <b>потолка по богатству</b> (таблица ниже). Постройки <b>складываются целиком</b> — каждый комплекс копает свой полный темп.</li>
        <li><b>Слоты — это рабочие руки.</b> Сколько их открыто, задаёт <a class="gb-link" onclick="gbScrollTo('gb-budget')">промышленный бюджет</a>, а населения системы должно хватать (вкладка «Благополучие»).</li>
      ...
      <div class="gb-note gb-note-info">
        <span class="gb-note-i">∑</span>
        <div><b>Формула добычи по залежи/сутки:</b> сумма всех шахт на планете, каждая = базовая скорость по редкости <b>× множитель богатства × бонус доктрины × множитель яруса × множитель слотов</b>, минимум 1. Сумма ограничена <b>потолком залежи</b> — он общий для всех шахт колонии, поэтому пятая шахта на одной планете почти ничего не добавит. Одна шахта потолком не режется никогда.</div>
      </div>

      <h3 class="gb-h3">Богатство месторождения</h3>
      <p>У каждой залежи на карте есть <b>богатство</b> — от «следов» до «колоссально». Оно работает <b>дважды</b>: множит темп добычи (×0.6 у «следов» … ×3.0 у «колоссально») и задаёт <b>потолок залежи</b> — сколько с неё можно снять в сутки всеми шахтами колонии вместе. Богатая жила и копается быстрее, и терпит больше шахт.</p>
      <p><b>Ярусы.</b> Шахта копает <b>все</b> залежи планеты, но профильные — быстрее: обычная 🔨 Шахта одинаково хороша на любом сырье, а ⛏ Глубокая (необычное и редкое) и 🧪 Экзотическая (эпическое и легендарное) вне своего яруса теряют <b>20%</b> темпа. <b>Слоты</b> шахты дают <b>+10% темпа за каждый сверх первого</b> — заполненная на 6 слотов копает в полтора раза быстрее.</p>
      ${gbRichTable()}
    ...
    <section id="gb-buildings" class="gb-section">
      ...
      <div class="gb-bld-grid">
        ...
        <div class="gb-bld"><div class="gb-bld-h"><span class="gb-bld-ic">⛏</span><b>Добывающий завод</b></div><div class="gb-bld-cost">500 ГС · 2 слота сразу</div><div class="gb-bld-d">Добыча <b>обычных</b> залежей планеты (сам ГС не даёт). Редкие и элитные месторождения ему не по зубам — см. <a class="gb-link" onclick="gbScrollTo('gb-resources')">ярусы добычи</a>.</div></div>
    ...
    <section id="gb-budget" class="gb-section">
      ...
      <div class="gb-table-wrap"><table class="gb-table">
        ...
        <tbody>
          <tr><td>🏭 <b>Промышленность</b></td><td>Слоты гражданских построек (фабрики, хабы, склады, храмы) и <b>темп добычи</b> — рудник копает быстрее с каждым слотом.</td><td>1 → 6 слотов</td></tr>
    ...
    <section id="gb-defense" class="gb-section">
      ...
      <div class="gb-note gb-note-warn">
        <span class="gb-note-i">!</span>
        <div><b>Мегасооружение и единственная абсолютная защита.</b> Кольцо перехватчиков вокруг системы <b>гарантированно сбивает любой залп</b> Длани и Гиперпейсера — без дуэли, без осечек, включая невидимые для обычной ПРО боеголовки. Цена под стать: <b>2 000 000 ГС</b> плюс 200 Стелларита, 40 Рагенода и 20 Гравиядра, стройка 3 дня, требует технологию «Ожерелье Немезиды». Заряды не бесконечны — их <b>6</b>.</div>
      </div>
    ...
    <section id="gb-constructors" class="gb-section">
      ...
      <div class="gb-kv-grid">
        <div class="gb-kv-row"><span class="gb-kv-key">🚀 Корабельная верфь</span><span class="gb-kv-val">Космический флот. Классы корпусов: <b>Корвет · Эсминец · Крейсер · Гиперкрейсер · Носитель поддержки · Ударный носитель · Линкор · Дредноут</b> и станция <b>СС-13</b>.</span></div>
    ...
    <section id="gb-doom" class="gb-section">
      ...
      <h3 class="gb-h3">🏭 Баллистика и Гиперпейсер</h3>
      ...
      <p><b>Гиперпейсер</b> — мобильная «Длань»: корабль-носитель, который возит орудие по карте. Стоит <b>1 200 000 ГС + 60 Программируемой материи</b>, залп жжёт <b>12 Гравиядра</b> и сильно изнашивает установку. Дальность — <b>4 прыжка</b> по гиперпутям от текущей позиции (тяжёлым снарядом — вдвое дальше). Главное его свойство: <b>чужой Гиперпейсер невидим на карте</b>, пока не выстрелит или пока его не вскроют спецоперацией «Подпространственная охота» (см. <a class="gb-link" onclick="gbScrollTo('gb-intel')">«Разведка»</a>).</p>
