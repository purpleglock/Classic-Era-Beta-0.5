...
const GB_TOC = [
  { group: 'Начало', items: [
    { id: 'gb-changes',    icon: '↯', label: 'Что изменилось' },
...
<div class="gb-wrap">
  ...
  <main class="gb-main">
    ...
    <!-- ЧТО ИЗМЕНИЛОСЬ: лента правок правил (_rules_updates.sql). Первым
         разделом намеренно: вернувшийся игрок должен упереться в перемены
         раньше, чем сядет играть по вчерашним правилам. -->
    <section id="gb-changes" class="gb-section">
      <h2 class="gb-h2"><span class="gb-h2-icon">↯</span>Что изменилось</h2>
      <p>Правила живые: баланс правится, механики появляются и уходят. Здесь — что поменялось и в каком разделе про это написано. Непрочитанное считает <b>колокол оповещений</b>.</p>
      <div id="gb-changes-list" class="gb-changes"><div class="gb-changes-empty">Читаю ленту правок…</div></div>
    </section>
    ...
    <section id="gb-colonies" class="gb-section">
      ...
      <h3 class="gb-h3">Природа мира</h3>
      <p>Класс планеты — это не только сложность заселения. Он множит <b>четыре</b> числа колонии, и множители видно прямо в её карточке:</p>
      <div class="gb-table-wrap"><table class="gb-table">
        <thead><tr><th>Класс</th><th>Население</th><th>Рабочие</th><th>Наука</th><th>Стройка</th></tr></thead>
        <tbody>
          <tr><td><b>Идеальный мир</b></td><td>+50%</td><td>+45%</td><td>+45%</td><td>−25%</td></tr>
          <tr><td>Землеподобный</td><td>+15%</td><td>—</td><td>+5%</td><td>−5%</td></tr>
          <tr><td>Океанический</td><td>+10%</td><td>−5%</td><td>+15%</td><td>—</td></tr>
          <tr><td>Пустынный</td><td>−10%</td><td>+10%</td><td>—</td><td>−5%</td></tr>
          <tr><td>Криомир</td><td>−20%</td><td>+5%</td><td>+15%</td><td>+15%</td></tr>
          <tr><td>Вулканический</td><td>−25%</td><td>+25%</td><td>−5%</td><td>+15%</td></tr>
          <tr><td>Лавовый</td><td>−40%</td><td>+30%</td><td>−10%</td><td>+25%</td></tr>
          <tr><td>Малое тело</td><td>−30%</td><td>+15%</td><td>—</td><td>−10%</td></tr>
          <tr><td>Экзотический</td><td>−15%</td><td>—</td><td>+25%</td><td>+20%</td></tr>
          <tr><td>Пояс астероидов</td><td>−40%</td><td>+30%</td><td>−5%</td><td>−10%</td></tr>
          <tr><td>Газовый гигант</td><td>−30%</td><td>+20%</td><td>+10%</td><td>+15%</td></tr>
          <tr><td>Ледяной гигант</td><td>−30%</td><td>+10%</td><td>+15%</td><td>+15%</td></tr>
          <tr><td>Горячий гигант</td><td>−35%</td><td>+25%</td><td>+5%</td><td>+20%</td></tr>
          <tr><td>Аномалия</td><td>−35%</td><td>−10%</td><td>+30%</td><td>+25%</td></tr>
        </tbody>
      </table></div>
      <ul class="gb-ul">
        <li><b>Население</b> двигает и потолок колонии, и скорость прироста. Отрицательный прирост (провальный соцблок) климат <b>не</b> ускоряет: хороший мир не вымирает быстрее плохого.</li>
        <li><b>Рабочие</b> — выработка залежей, фабрик и торговых домов.</li>
        <li><b>Наука</b> — все научные постройки колонии, включая станционные.</li>
        <li><b>Стройка</b> — цена постройки и открытия слота в этой колонии.</li>
      </ul>
      <div class="gb-note gb-note-info">
        <span class="gb-note-i">i</span>
        <div>Плохого класса нет — есть <b>специализация</b>. Лава и пояса — это рудный цех с тяжёлой демографией, аномалии и экзотика — лаборатории, землеподобные и океанические — дом, где растут люди. Смотрите на класс, когда решаете, <b>что</b> здесь строить, а не <b>стоит ли</b> садиться.</div>
      </div>

      <h3 class="gb-h3">Идеальные миры</h3>
      <p>Отдельный класс, которого не было при сотворении галактики. Так выглядят миры, <b>переплавленные кризисом «Престол»</b>: то, что осталось после него, остыло и оказалось пригоднее всего, что мы знали. Дебафов у идеального мира нет ни одного, а по каждой оси он заметно выше лучшего обычного класса.</p>
      <ul class="gb-ul">
        <li>Прежних владельцев, ячеек и построек на них не осталось — это <b>чистый лист</b>, свободный для колонизации кем угодно.</li>
        <li>Восемь ячеек под застройку, заселяются как землеподобные.</li>
        <li>Больше их не станет: новых переплавок нет, а кризис ушёл к Храму мироздания.</li>
      </ul>
      <div class="gb-note gb-note-info">
        <span class="gb-note-i">⚙</span>
    ...
    <section id="gb-resources" class="gb-section">
      ...
      <p>Аванпост — единственный способ работать <b>вне своих границ</b>. Сначала на <b>Корабельной Верфи</b> закладывается носитель (<b>${GB_OPC.ship} ГС</b>, ${GB_OPC.buildH} ч), затем с карты он летит в <b>любую</b> систему (${GB_OPC.flyH[0]}–${GB_OPC.flyH[1]} ч в зависимости от дальности) и разворачивается в одном из трёх режимов. Ограничение одно: <b>аванпост в системе один</b> — чья застава встала первой, того и место (колониям и флотам других держав это не мешает). Разбор своего аванпоста возвращает <b>${Math.round(GB_OPC.refund * 100)}%</b> стоимости; чужой можно <b>снести боевым флотом</b>, стоящим в той же системе, — но только в состоянии войны.</p>
      ${gbOpModeTable()}
      ...
      <p>Пустой бак больше не приговор. Три дороги домой, от медленной к быстрой:</p>
      <ul class="gb-ul">
        <li><b>☀ Сбор у звезды.</b> Флот на стоянке цедит топливо сам: <b>+1 плечо за 6 часов</b>, до полного бака. Даром и без всякой инфраструктуры — но медленно.</li>
        <li><b>🛢 Разграбить систему.</b> В системе, которую <b>держит ваша держава</b> (оккупация после победы), флот выкачивает склады хозяина: до <b>половины бака</b> разом, <b>раз в сутки</b> на систему. Взятое списывается со склада владельца системы.</li>
        <li><b>⛽ Чужая застава по договору.</b> Держава может <b>запросить право</b> пользоваться заставами соседа, а владелец — <b>дать или отозвать</b> его в разделе «Аванпосты». С правом чужая застава заправляет как своя; без него — не пустит.</li>
      </ul>
      ${gbTkCalc()}
      <div class="gb-note gb-note-tip">
        <span class="gb-note-i">★</span>
    ...
    <section id="gb-doom" class="gb-section">
      ...
      <div class="gb-table-wrap"><table class="gb-table">
        ...
        <tbody>
          ...
          <tr><td><b>Х77 «Сполох»</b><br><span class="gb-cap-foot">противофлотовая баллистика</span></td><td>120 000 ГС · 3 Гравиядра</td><td>Бьёт не по планете, а по <b>флоту</b>: ведёт тепловую сигнатуру, уйти из системы бесполезно. Сбить может только зенитный огонь самого флота (лёгкие скорострелки, ЗУР, свои стволы малого калибра с высоким темпом) или Ожерелье Немезиды над системой. Не сбили — 15–35% кораблей уничтожено</td></tr>
  ...
  gbApplyCovers();
  gbChangesLoad();      // лента правок правил (_rules_updates.sql)
...
// ══════════════════════════════════════════════════════════════════════
// ЧТО ИЗМЕНИЛОСЬ — лента правок правил.
//
// Текст правил остаётся ТАМ, где ему место (в своём разделе), а здесь только
// «что поменялось» и ЯКОРЬ туда: иначе через месяц лента станет вторым,
// расходящимся сводом правил. Запись заводит стафф в админке.
// Открытие гайдбука гасит счётчик: правки — чтение, а не дело (kind:'new').
// ══════════════════════════════════════════════════════════════════════
const GB_CH = { list: [] };

// Гайдбук читают и БЕЗ входа в игру — правила публичны. ecRpc требует живую
// сессию и на госте падает «Сессия истекла», поэтому гостю (и при севшем
// токене) ходим анонимным ключом: RPC разрешён роли anon.
async function gbRulesFetch() {
  const logged = (typeof user !== 'undefined' && user);
  if (logged && typeof ecRpc === 'function') {
    try { return await ecRpc('rules_updates_list', { p_limit: 30 }); } catch (e) { /* ниже — гостевой путь */ }
  }
  const r = await fetch(`${SB_URL}/rest/v1/rpc/rules_updates_list`, {
    method: 'POST',
...
async function gbChangesLoad() {
  const box = document.getElementById('gb-changes-list');
  if (!box) return;
  try {
    const r = await gbRulesFetch();
    GB_CH.list = Array.isArray(r) ? r : [];
    box.innerHTML = gbChangesRows(GB_CH.list);
    // Прочитано: игрок открыл раздел с правками — бейдж гасим.
    if (typeof ntMark === 'function' && GB_CH.list.some(x => x.is_new)) ntMark('rules');
  } catch (e) {
    box.innerHTML = `<div class="gb-changes-empty">Лента правок недоступна: ${esc(e.message || e)}</div>`;
  }
}

function gbChangesRows(list) {
  if (!list.length) return `<div class="gb-changes-empty">Правил пока не меняли.</div>`;
  const sec = Object.fromEntries(GB_SECTIONS.map(s => [s.id, s.label]));
  return list.map(u => {
    const d = u.at ? new Date(u.at) : null;
    const when = d ? d.toLocaleDateString('ru-RU', { day: '2-digit', month: 'long' }) : '';
    const link = u.anchor && sec[u.anchor]
      ? `<button class="gb-ch-go" onclick="gbScrollTo('${esc(u.anchor)}')">${esc(sec[u.anchor])} →</button>`
      : '';
    return `<article class="gb-ch${u.is_new ? ' is-new' : ''}">
      <div class="gb-ch-head">
        <span class="gb-ch-date">${esc(when)}</span>
        ${u.tag ? `<span class="gb-ch-tag">${esc(u.tag)}</span>` : ''}
        ${u.is_new ? '<span class="gb-ch-new">новое</span>' : ''}
      </div>
      <h3 class="gb-ch-t">${esc(u.title || '')}</h3>
      <p class="gb-ch-b">${esc(u.body || '').replace(/\n+/g, '<br>')}</p>
      ${link}
    </article>`;
  }).join('');
}
...
// more  — второй абзац: подробность, которой в карточке тесно в lead (html)
...
const GB_TOPICS = {
  ...
  legion: {
    ...
    steps: ['Держать разведаванпосты с полным экипажем', 'Смотреть ленту подхода и долг', 'Встречать флотом на выходе с троп'],
    ...
    more: '<b>Крысиные тропы и перехват.</b> Летящий контакт — не флот: пока он идёт задворками, его не за что взять, и гоняться за отметкой на карте бесполезно. В обжитое пространство Легион выходит только на <b>последних двух прыжках</b> перед целью — эти два узла и есть единственное место, где ватагу можно встретить до налёта. Оба узла со временем прохода показаны на карточке угрозы, но лишь на ступени «вскрыт», то есть только тем, кто держит рядом разведзаставу с полным экипажем.<br><br>Засаду не надо объявлять: <b>засада — это флот, стоящий в узле</b>. Успел встать до часа прохода — ватага выйдет из пустоты там, налёт сорвётся, а бой начнётся сразу. Не успел или встал не в том узле — они дойдут до цели, и тогда всё решает прикрытие в самой системе: пустую систему грабят и уходят в пустоту тем же часом.',
  },
...
function gbTopicCard(key) {
  ...
  return `<article class="gb-topic" id="gbt-${key.replace(':', '-')}">
    ...
    ${t.more ? `<p class="gb-topic-more">${t.more}</p>` : ''}
