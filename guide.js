...
// Потолок добычи одной постройки по богатству залежи — зеркало EC_MINE_CAP
// (economy.js) и public._mine_cap. Верхняя планка с баффами доктрины — 70.
const GB_RICHNESS = [
  ['Следы',        2], ['Мало',         4], ['Умеренно',    6],
  ['Много',        8], ['Очень много', 11], ['Колоссально', 14],
];
  ...
  <main class="gb-main">
    ...
    <section id="gb-intro" class="gb-section">
      ...
      <div class="gb-kv-grid">
        ...
        <div class="gb-kv-row"><span class="gb-kv-key">🕵 Разведка</span><span class="gb-kv-val">Агенты, рынок рекрутов, операции, контрразведка и расследования.</span></div>
    ...
    <section id="gb-resources" class="gb-section">
      ...
      <div class="gb-note gb-note-info">
        <span class="gb-note-i">∑</span>
        <div><b>Формула добычи по залежи/сутки:</b> сумма построек своего яруса, каждая = базовая скорость по редкости <b>× множитель богатства × бонус доктрины × (слоты ÷ 3)</b>, минимум 1, но не выше <b>потолка постройки</b>: потолок по богатству × баффы, максимум 70.</div>
      </div>

      <h3 class="gb-h3">Богатство месторождения</h3>
      <p>У каждой залежи на карте есть <b>богатство</b> — от «следов» до «колоссально». Оно работает <b>дважды</b>: множит темп добычи (×0.6 у «следов» … ×3.0 у «колоссально») и задаёт <b>потолок добычи одной постройки в сутки</b>. Постройки складываются, потолок считается для каждой отдельно.</p>
      ${gbRichTable()}
