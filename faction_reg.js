...
const FR_RACE_DESC = {
  ...
  'Синтетики / Киборги': 'Искусственно созданные или радикально аугментированные механизмы. Игнорируют терраформирование, колонизируя ВСЕ типы планет, и штампуют пехоту на Военных Заводах в промышленных масштабах (×3). Форсированные вычисления позволяют проводить 2 исследования и 2 захвата за цикл. Обратная сторона — чудовищное энергопотребление, налагающее тяжелейший штраф на экономику (−35% к доходу).',
