...
const AD_PC_KEYS = [
  ...
  ['lesson',  'УРК', 'Решение: Урок будет усвоен (карательный удар флотом)'],
  ['rite',    'ОБР', 'Решение: Оккультный обряд (мир в жертву за ихор)'],
  ...
  ['mood_hostile', 'ВРЖ', 'Голос мира: враждебны (шапка досье, широкий кадр)'],
  ['mood_craven',  'ЗАВ', 'Голос мира: карго-культ, зависимость от подачек'],
  ['mood_plea',    'БЕД', 'Голос мира: у них беда'],
  ['mood_warm',    'ТПЛ', 'Голос мира: тепло, но ещё не преданы'],
  ['mood_devoted',  'ПРД', 'Голос мира: преданы'],
  ['mood_covenant', 'ЗВТ', 'Голос мира: Завет заключён'],
  ['mood_wary',    'НСТ', 'Голос мира: настороженно, контакт свежий'],
  ['mood_legacy',  'ИТГ', 'Голос мира: мертвы или вышли к звёздам'],
];
